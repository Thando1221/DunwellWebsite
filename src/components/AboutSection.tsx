  ...
  return (
    <section id="about" className="py-20 bg-muted/50">
      <div className="container mx-auto px-4">
        ...
        >
          <span className="text-turquoise font-semibold text-base uppercase tracking-widest">About Us</span>
        ...
        >
          <span className="text-turquoise font-semibold text-base uppercase tracking-widest">Leadership</span>
